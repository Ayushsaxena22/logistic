        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-green-500/30 shadow-lg">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              className="w-full rounded-xl bg-black p-3 border border-green-500/30 focus:border-green-500 outline-none"
            />
            <input
              type="email"
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-green-500 py-3 font-semibold text-black hover:bg-green-600 transition"
            >
              <Send size={18} />
              Send Message
            </button>
